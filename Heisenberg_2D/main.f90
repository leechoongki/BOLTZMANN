...
!     namelist/input/Nx,Ny,kh,Nw,L,eta0
...
!     read(5,nml=input)
      ...
      write(9,*)
      write(9,*) "N.N. sites for each visible neuron"
      do k = 1, nv
         write(9,*) k,(innd(k,i),i=1,nz)
      enddo
...
!     write(6,'(i5,x,a,x,f10.5,x,f10.5,x,f10.5,x,f10.5,x,a,f10.5)') npi,"Egs = ", egs, evariance, gradnorm,"CPU TIME=", cputime2 - cputime1
      write(6,21) npi,"Egs = ", egs, evariance, gradnorm,eta,"CPU TIME=", cputime2 - cputime1
...
!     deallocate(gmm_real,gmm_imag)
 ...
 21   format(i5,x,a,x,f10.5,x,f10.5,x,f10.5,x,f10.5,x,f10.5,a,f10.5)
